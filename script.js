...
document.getElementById('simulate-button').addEventListener('click', function () {
    ...
    document.getElementById('check-medicine').addEventListener('click', function() {
        ...
        const medicineDatabase = {
            ...
            "paracetamol": {
                safe: true,
                reason: "✅ Used for mild fever. Can cause drowsiness."
            },
            "meclizine": {
                safe: true,
...
const OPENWEATHER_API_KEY = '0ef5a9fba7aa0bc93ae15cc623d0d4c2';
const AIRVISUAL_API_KEY = '591e51d9-fe85-4583-ba7a-8ea2b4e424df';
